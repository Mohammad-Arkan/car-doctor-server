...
// const uri = "mongodb+srv://CAR-DOCTOR:B2UVpZax4zE46WRR@cluster0.o8biysy.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
  try {
    ...
    const serviceCollection = client.db("CAR-DOCTOR").collection("car-service");
